        ...
        <div class="col-12 col-md-3 footer-content-contact footer-link-wrap">
          ...
          <ul class="list-unstyled">
            @if ($footer_content['content']['contact']['email'])
              <li class="lh-lg mb-2"><i class="bi bi-envelope-fill"></i><a href="mailto:{{ $footer_content['content']['contact']['email'] }}"
         class="text-decoration-none, text-decoration:hover">
        {{ $footer_content['content']['contact']['email'] }}
      </a></li>
            @endif
            @if ($footer_content['content']['contact']['telephone'])
              <li class="lh-lg mb-2"><i class="bi bi-telephone-fill"></i> <a href="tel:{{ $footer_content['content']['contact']['telephone'] }}"
         class="text-decoration-none, text-decoration:hover">
        {{ $footer_content['content']['contact']['telephone'] }}
      </a></li>
            @endif
            @if ($footer_content['content']['contact']['address'][locale()] ?? '')
              <li class="lh-lg mb-2"><i class="bi bi-geo-alt-fill"></i> <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($footer_content['content']['contact']['address'][locale()]) }}"
         class="text-decoration-none, text-decoration:hover"
         target="_blank">
        {{ $footer_content['content']['contact']['address'][locale()] ?? '' }}
      </a></li>
            @endif
          </ul>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col">
          <div class="d-flex flex-wrap">
            ...
            @if(!check_license())
              Powered By&nbsp;<a href="https://ultraservice.md/" target="_blank" rel="noopener">Alexandru Mămăligă</a>&nbsp;-&nbsp;
            @endif
