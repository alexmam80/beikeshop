    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="right nav">
        @if (system_setting('base.telephone', ''))
          ...
          <div class="my-auto"><a href="tel:{{ system_setting('base.telephone') }}" class="text-decoration-none, text-decoration:hover"><i class="bi bi-telephone-forward me-2"></i> {{ system_setting('base.telephone') }}</a></div>
          @endhookwrapper
        @endif
